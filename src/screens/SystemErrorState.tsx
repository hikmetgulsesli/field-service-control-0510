...
export function SystemErrorState(props: SystemErrorStateProps) {
  ...
  const errorCode = state.lastError?.code ?? "ERR_UNKNOWN";
  const errorMessage = state.lastError?.message ?? "An unknown error occurred.";
        ...
        <div className="bg-surface-container border border-surface-variant rounded-xl p-xl flex flex-col items-center text-center shadow-[0px_4px_12px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col w-full sm:flex-row items-center justify-center gap-md">
            ...
            <button
              ...
              className="w-full sm:w-auto px-lg py-[10px] rounded-lg border border-outline-variant bg-transparent text-on-surface font-label-md text-label-md hover:bg-surface-container-high transition-colors focus:ring-2 focus:ring-primary-container focus:outline-none focus:ring-offset-2 focus:ring-offset-background"
            >
              Clear Storage &amp; Reset
            </button>
            {/* Primary Action */}
            <button
              ...
              className="w-full sm:w-auto px-lg py-[10px] rounded-lg bg-primary-container text-on-primary-container font-label-md text-label-md hover:bg-inverse-primary transition-colors focus:ring-2 focus:ring-primary-container focus:outline-none focus:ring-offset-2 focus:ring-offset-background flex items-center justify-center gap-sm"
            >
          ...
          <div className="mt-lg pt-lg border-t border-surface-variant w-full">
            <p className="font-mono-data text-mono-data text-outline flex items-center justify-center gap-xs">
